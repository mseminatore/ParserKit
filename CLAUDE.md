...
| `examples/script/` | Tiny scripting language (`ScriptParser`); demonstrates `pushFile()` file inclusion, `parseData()`, and an overridden `yyerror()` with panic-mode error recovery |
